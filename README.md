...
Create a Repository: Go to GitHub, create a new public repository (e.g., fast-auth), and upload this index.html file to it.

Enable Pages: Go to your repository's Settings > Pages, set the source branch to main, and click Save.

Get Your Link: Wait a minute for GitHub to build your site. Your base URL will be https://[your-username].github.io/[repo-name]/.

Add Your Key: Append your Base32 secret key to the end of your new URL preceded by a question mark: https://[your-username].github.io/fast-auth/?JBSWY3DPEHPK3PXP

Bookmark It: Save that exact URL. Whenever you need your code, simply click the link.
